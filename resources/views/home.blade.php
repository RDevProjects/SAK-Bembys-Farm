...
<body class="bg-white">
        ...
        <div id="main-wrapper" class="flex">
            ...
            <div class=" w-full page-wrapper overflow-hidden">
                ...
                <header class="container full-container w-full text-sm py-5 xl:px-9 px-5">
                    ...
                    <nav class=" w-full bg-gray-800 dark:bg-white  flex items-center justify-between"
                        aria-label="Global">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="p-4">
                                                            <div class="flex flex-col gap-1">
                                                                ...
                                                                <span
                                                                    class="font-normal text-sm text-gray-500">Frontend
                                                                    Engineer</span>
                                                            </div>
                                                        </td>
                                                        <td class="p-4">
    ...
    <script src="{{ asset('dashboard/@preline/dropdown/index.js') }}"></script>
